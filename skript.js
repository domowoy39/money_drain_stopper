...
Вижу проблему — в коде который ты скопировал, шаблонные строки с переносами (\n) экранированы как \\n. При копировании через чат они превратились в буквальные символы \n вместо реальных переносов строк — эт
